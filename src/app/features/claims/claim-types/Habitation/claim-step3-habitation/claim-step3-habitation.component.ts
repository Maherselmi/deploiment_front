...
export class ClaimStep3HabitationComponent implements OnInit {
  ...
  // Liste des prochaines étapes affichées après l’envoi du dossier habitation
  ...
  // Référence du dossier habitation affichée à l’utilisateur
  reference = '';
  ...
  // Elle génère la référence du dossier habitation
  ngOnInit(): void {
  ...
  // Méthode permettant de générer une référence pour le dossier habitation
  ...
  // Méthode permettant de démarrer une nouvelle déclaration de sinistre habitation
  newClaim(): void {
