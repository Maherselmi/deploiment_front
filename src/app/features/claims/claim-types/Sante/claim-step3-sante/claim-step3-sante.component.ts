...
export class ClaimStep3SanteComponent implements OnInit {
  ...
  // Liste des prochaines étapes affichées après l’envoi du dossier santé
  ...
  // Référence du dossier santé affichée à l’utilisateur
  reference = '';
  ...
  // Elle génère la référence du dossier santé
  ngOnInit(): void {
  ...
  // Méthode permettant de générer une référence pour le dossier santé
  ...
  // Méthode permettant de démarrer une nouvelle déclaration de sinistre santé
  newClaim(): void {
